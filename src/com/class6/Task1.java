...
public class Task1 {
	public static void main(String[] args) {
		 ...
		 * sale ---->check the price of the item base on the amount we will have to
		 * calculate the price after discount if price >20 --> apply 10% if price
		 * between 20-100--->20% if price between 100-500--> 30% anything -->50% After
		 * discount____the price of the item reduce from____to____
		 */
