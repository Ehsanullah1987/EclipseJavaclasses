...
public class Card {
	/*
	 * define a class card with 2 methods and this class should have 4 subclasses inng shich some behavior can be oberridden and some
	 * can  it is own behavior
	 */
...
class Discovery extends Card{
	public void applePay() {
		System.out.println("Discovery can take appley pay");
	}
}
