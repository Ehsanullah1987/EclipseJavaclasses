...
public class NestedIMore {
	public static void main(String[] args) {
		/*check age, if age is less than 16 --> you are too young to drivve 
		...
		int age=55;
		if(age<16) {
			System.out.println("You ae too young to drive");
		}else {
		...
		/* we need to check if students complete the quiz
		 * if yes----> good job, if not---->not good
		 * if they completed we will check score:
		 * if more than 90--> you got a A
